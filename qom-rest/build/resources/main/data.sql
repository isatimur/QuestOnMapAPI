        ...
        INSERT INTO account(login,username,password,avatar) VALUES ('timur@mail.ru','isatimur','admin','/');
        INSERT INTO account(login,username,password,avatar) VALUES ('tema@mail.ru','tema','admin','/');
